            ...
            do {
                ...
                jsonCompanies.forEach({ (jsonCompany) in
                    ...
                    jsonCompany.employees?.forEach({ (jsonEmployee) in
                        ...
                        let birthdatDate = dateFormatter.date(from: jsonEmployee.birthday)
                        employeeInformation.birthday = birthdatDate
                        employee.employeeInformation = employeeInformation
                        
                        
                        employee.company = company  //without this line, you get zero employees when clicking on company's row entry
